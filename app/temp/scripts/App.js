...
var MobileMenu = function () {
    // Define your DOM selections in constructor function
    function MobileMenu() {
...
var StickyHeader = function () {
    ...
    _createClass(StickyHeader, [{
        ...
        value: function createHeaderWaypoint() {
            var that = this;
            new Waypoint({
                element: this.headerTriggerElement[0], // [0] to access dom element, because element property ia asking for a native dom element, not jquery object selection
